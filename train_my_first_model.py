...
dataset = load_dataset(
    "csv", data_files="data/whoami.csv", split="train")
...
new_dataset = new_dataset.train_test_split(
    0.05)  # Let's keep 5% of the data for testing
...
def tokenize_function(example):
    tokens = tokenizer(
        example['prompt'], padding="max_length", truncation=True, max_length=128)
...
training_args = TrainingArguments(
    output_dir="./output_my_first_model",
...
trainer.save_model("./output_my_first_model")
tokenizer.save_pretrained("./output_my_first_model")
